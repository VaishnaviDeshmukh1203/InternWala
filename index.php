...
<body>
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative padding: 30px 0 60px" data-aos="zoom-out">
            <img src="assets/img/hero-carousel/hero-carousel-1.svg" class="img-fluid animated">
            <h2>Welcome to <span>InternWala</span></h2>
            <p>Your Dream Internship is just a click away.</p>
            <div class="d-flex">
            ...
            <div class="container" data-aos="zoom-out">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-8 col-md-6 content d-flex flex-column justify-content-center order-last order-md-first">
                        <h3> <em>Internship Portal</em> </h3>
                        <p>Internships offer students the chance to put what they are learning into action, in a real-world environment. This helps you better understand the theories and strategies you have been reading about, cementing the learning process and giving you greater focus.
                            <br>InternWala operates round the year to facilitate contacts between companies
                            and graduates. The number of students who got internship through the campus interviews is
                            continuously rising.
                        </p>
